...
public class UnityLineRender : MonoBehaviour
{
    ...
    LineRenderer l;
    public float col1 = 0.3f;
    public float col2= 0.4f;
    public float col3= 0.6f;
    public float col4= 0.3f;
    ...
    void Start()
    {
        l = gameObject.AddComponent<LineRenderer>();
         //newColor = new Color(0.3f, 0.4f, 0.6f, 0.3f)
    ...
    void Update()
    {
        ...
        */
        ...
        newColor = new Color(col1, col2, col3, col4);
